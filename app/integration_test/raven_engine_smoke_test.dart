...
void main() {
  ...
  test('raven int8 4-step engine synthesizes a short phrase on-device',
      () async {
    ...
    Future<TtsSynthesisResult> synth(int index) async {
      ...
      _mark('RUN$index NATIVE_RTF ${r.nativeRealTimeFactor.toStringAsFixed(3)}');
      _mark('RUN$index PIPELINE_RTF '
...
/// Emits a greppable marker to logcat, matching the sherpa smoke test.
